...
;symbol:Symbol{nr=12, identyfikator='k', zakres=3, automatyczny kot pktWe=null}
                lea eax, [ebp-12]
;koniec ładowania lwartosci
                push eax;lewa strona przypisania
;alokacja34:7
...
;przypisanie34:18
;załadowanie lwartości:34 niederef:true true
;symbol:Symbol{nr=13, identyfikator='m', zakres=3, automatyczny kot pktWe=null}
                lea eax, [ebp-16]
;koniec ładowania lwartosci
                push eax;lewa strona przypisania
;alokacja34:20
...
;symbol:Symbol{nr=12, identyfikator='k', zakres=3, automatyczny kot pktWe=null}
                mov eax,  [ebp-12]
;koniec ładowania lwartosci
        lea eax, [eax+4];typ:kot.całk(kt:0)
...
;symbol:Symbol{nr=12, identyfikator='k', zakres=3, automatyczny kot pktWe=null}
                mov eax,  [ebp-12]
;koniec ładowania lwartosci
        lea eax, [eax+14];typ:kot.kot(kt:0)
...
;symbol:Symbol{nr=14, identyfikator='i', zakres=3, automatyczny całk  /*inicjalizowany*/ pktWe=null}
...
;symbol:Symbol{nr=15, identyfikator='j', zakres=3, automatyczny całk pktWe=null}
                lea eax, [ebp-20]
;koniec ładowania lwartosci
                push eax;lewa strona przypisania
...
;wypisanie w linii52
;wypisanie wyrazenia
;typ wyrazenia:automatyczny całk  /*inicjalizowany*/ 
...
;koniec wypisania w linii52
;wypisanie w linii53
;wypisanie wyrazenia
;typ wyrazenia:stały znak [] /*inicjalizowany*/ 
;załadowanie lwartości:53 niederef:null false
;symbol:Symbol{nr=16, identyfikator='null', zakres=4, stały znak [] /*inicjalizowany*/ pktWe=null}
                lea eax, [Sznak_4_16__P_main]
;koniec ładowania lwartosci
...
;koniec wypisania w linii53
;wypisanie w linii54
;wypisanie wyrazenia
;typ wyrazenia:automatyczny całk 
;załadowanie lwartości:54 niederef:null false
;symbol:Symbol{nr=15, identyfikator='j', zakres=3, automatyczny całk pktWe=null}
                mov eax,  [ebp-20]
;koniec ładowania lwartosci
                sub esp, 4
                ...
                add esp, byte 8
;koniec wypisania - całk
;koniec wypisania w linii54
;wypisanie w linii55
;wypisanie wyrazenia
;typ wyrazenia:stały znak [] /*inicjalizowany*/ 
;załadowanie lwartości:55 niederef:null false
;symbol:Symbol{nr=17, identyfikator='null', zakres=4, stały znak [] /*inicjalizowany*/ pktWe=null}
                lea eax, [Sznak_4_17__P_main]
;koniec ładowania lwartosci
                push eax;wartosc na stos
                push dword WYPISZ_NAPIS_FMT
                call _printf
