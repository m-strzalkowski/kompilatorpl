...
public interface parserDebugeraVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link parserDebugera#ogolne_listowanie}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOgolne_listowanie(parserDebugera.Ogolne_listowanieContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link parserDebugera#pisz_symbole}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPisz_symbole(parserDebugera.Pisz_symboleContext ctx);
	/**
	 * Visit a parse tree produced by {@link parserDebugera#pisz_symbol}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitPisz_stan_maszyny_deklaracyjnej(parserDebugera.Pisz_stan_maszyny_deklaracyjnejContext ctx);
}